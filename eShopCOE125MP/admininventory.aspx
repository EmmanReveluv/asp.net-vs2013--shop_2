<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="admininventory.aspx.cs" Inherits="eShopCOE125MP.admininventory" %>
            ...
            <div id="heading-breadcrumbs">
                <div class="container">
                    <div class="row">
                        <div class="col-md-7">
                            <h1>
                                <asp:Label runat="server" Text="Inventory"></asp:Label></h1>
                        </div>
                ...
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 clearfix" id="basket">
                            <div class="box">
                                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="id" DataSourceID="SqlDataSource1" CellPadding="6">
                                    <Columns>
                                        <asp:HyperLinkField HeaderText="ID" DataTextField="id" DataNavigateUrlFields="id" DataNavigateUrlFormatString="adminview.aspx?id={0}" />
                            ...
                            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:dbStoreConnectionString %>" SelectCommand="productallSelect" SelectCommandType="StoredProcedure" UpdateCommand="basicUpdateProduct" UpdateCommandType="StoredProcedure">
                                <UpdateParameters>
