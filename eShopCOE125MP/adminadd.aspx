<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="adminadd.aspx.cs" Inherits="eShopCOE125MP.adminadd" validateRequest="false"  %>
            ...
            <div id="heading-breadcrumbs">
                <div class="container">
                    <div class="row">
                        <div class="col-md-7">
                            <h1>
                                <asp:Label runat="server" Text="Add Item"></asp:Label></h1>
                        </div>
                            ...
                            <div class="box">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-6 col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <asp:TextBox ID="txtRs1Pho" runat="server" CssClass="form-control" text="0"   onkeydown = "return (!(event.keyCode>=65) && event.keyCode!=32);" MaxLength="50" />
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-sm-6 col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <asp:TextBox ID="txtRs2Pho" runat="server" CssClass="form-control" text="0"  onkeydown = "return (!(event.keyCode>=65) && event.keyCode!=32);" MaxLength="50" />
                                                    </div>
                                                </div>
                                                <div class="col-sm-12">
                                                    <div class="form-group">
                                                ...
                                                <div class="col-sm-6 col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <asp:TextBox ID="txtFeat" runat="server" CssClass="form-control" text="0" onkeydown="return ((event.keyCode==48) || event.keyCode==49  || event.keyCode==08);" MaxLength="1" />
                                                    </div>
                                                </div>
                                        ...
                                        <div class="box-footer">
                                            ...
                                            <div class="pull-right">
                                                ...
                                                <asp:Button runat="server" CssClass="btn btn-template-main" ID="btnUpdate" Text="Add" OnClick="btnUpdate_Click" />
                                                <br /><br />
                                            </div>
                                        </div>
                            </div>
