<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="adminmessages.aspx.cs" Inherits="eShopCOE125MP.adminmessages" %>
            ...
            <div id="heading-breadcrumbs">
                <div class="container">
                    <div class="row">
                        <div class="col-md-7">
                            <h1>
                                <asp:Label runat="server" Text="Messages"></asp:Label></h1>
                        </div>
                            ...
                            <div class="content">
                                    ...
                                    <asp:DataList ID="DataList1" runat="server" DataSourceID="SqlDataSource1">
                                        <ItemTemplate>
                                            <p class="lead">
                                           From:
                                          <em><asp:Label ID="emailLabel" runat="server" Text='<%# Eval("email") %>' /></em>  
                                             sent:
                                            <i>
                                            <asp:Label ID="dateLabel" runat="server" Text='<%# Eval("date") %>' /></i> <a href='<%# Eval("mid", "adminmessages.aspx?delete={0}") %>'><i class="fa fa-trash-o"></i></a>
                                            <br />
                                            Message:<br />
...
_________________________________________________________ -->
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:dbStoreConnectionString %>" SelectCommand="inboxSelect" SelectCommandType="StoredProcedure"></asp:SqlDataSource>
