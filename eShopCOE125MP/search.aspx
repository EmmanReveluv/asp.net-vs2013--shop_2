<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="search.aspx.cs" Inherits="eShopCOE125MP.search" %>
...
_________________________________________________________ -->
        ...
        <!-- /#all -->
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:dbStoreConnectionString %>" SelectCommand="searchSelect" SelectCommandType="StoredProcedure">
            <SelectParameters>
