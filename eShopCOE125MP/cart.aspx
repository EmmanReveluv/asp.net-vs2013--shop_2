<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="cart.aspx.cs" Inherits="eShopCOE125MP.cart" %>
            ...
            <div id="heading-breadcrumbs">
                <div class="container">
                    <div class="row">
                        <div class="col-md-7">
                            <h1>
                                <asp:Label runat="server" Text="Cart"></asp:Label></h1>
                        </div>
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <asp:Label runat="server" Text="Item added to cart!" Visible="false" id="lblAdded"></asp:Label>
                        </div>
                        ...
                        <div class="col-md-9 clearfix" id="basket">
                            ...
                            <div class="box">
                                                ...
                                                <ItemTemplate>
                                                    <tr>
                                                        ...
                                                        <td style="text-align: right; width: 30%">
                                                            <asp:Label runat="server" Text='<%# Eval("price", "PHP {0}") %>'></asp:Label></td>
                                                        <td style="text-align: right; width: 10%"><a href='<%# Eval("cartnum", "cart.aspx?delete={0}") %>'><i class="fa fa-trash-o"></i></a>
                                                        </td>
                                                    </tr>
                                ...
                                <div class="box-footer">
                                    <div class="pull-left">
                                        <a href="categ.aspx" class="btn btn-default"><i class="fa fa-chevron-left"></i>Continue shopping</a>
                                    </div>
                                    <div class="pull-right">
                                        <asp:Button runat="server" ID="btnCheckout" visible="false" Text="Proceed to checkout" CssClass="btn btn-template-main" OnClick="btnCheckout_Click" />
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <th style="text-align: right">
                                                    <asp:Label runat="server" ID="lblTotal1" Text="PHP 0" /></th>
                                            </tr>
                                            <tr>
                                                <td>Discount</td>
                                                <th style="text-align: right">
                                            ...
                                            <tr class="total">
                                                <td>Total</td>
                                                <th style="text-align: right">
                                                    <asp:Label runat="server" ID="lblTotal2" Text="PHP 0" Font-Size="Medium"></asp:Label></th>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
