<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="compare.aspx.cs" Inherits="eShopCOE125MP.compare" %>
...
<head>
    ...
    <title>Cool World | Compare</title>
            ...
            <div id="heading-breadcrumbs">
                <div class="container">
                    <div class="row">
                        <div class="col-md-7">
                            <h1>
                                <asp:Label runat="server" Text="Compare" ID="lblHead"></asp:Label></h1>
                        </div>
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-sm-5">
                            <h2>ITEM 1</h2>
                            <br />
                            <asp:DataList ID="dataview1" DataSourceID="SqlDataSource1" runat="server">
                                <ItemTemplate>
                                    <div style="width: 100%; max-width: 500px;">
                                    <table style="width:100%">
                                        <tr>
                                            <asp:Image runat="server" src='<%# Eval("pic1src") %>' height="300px" />
                                        </tr>
                                        <tr><h1>
                                        ...
                                        <tr>
                                            ...
                                            <h4>
                                                <asp:Label runat="server" Text='<%# Eval("name") %>'></asp:Label></h4>
                                        </tr>
                                        <tr>
                                            <p>
                                                <asp:Label runat="server" Text='<%# Eval("description") %>'></asp:Label></p>
                                        </tr>
                                    </table>
                                        </div>
                                </ItemTemplate>
...
_________________________________________________________ -->
        ...
        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:dbStoreConnectionString %>" SelectCommand="productSelect" SelectCommandType="StoredProcedure">
            <SelectParameters>
                <asp:Parameter Name="id" Type="Int32" />
            </SelectParameters>
        </asp:SqlDataSource>
